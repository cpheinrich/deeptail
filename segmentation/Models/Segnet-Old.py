...
# Note from Chris -- I don't think this is the true segnet architecture since it
# does not have the skip layers that connect the maxpooling layers in the
# encoder to the upsampling layers in the decoder
